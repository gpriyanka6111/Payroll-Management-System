    ...
    <div className="space-y-6">
       <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground">Review and manage past payroll runs.</p>
        </div>
        <Button asChild>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center"><History className="mr-2 h-5 w-5 text-muted-foreground"/> Past Payrolls</CardTitle>
