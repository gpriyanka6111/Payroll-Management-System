...
export const employees = [
  ...
  { id: 'emp005', firstName: 'Eve', lastName: 'Adams', email: 'eve.adams@example.com', mobileNumber: '5678901234', ssn: '***-**-4567', payMethod: 'Hourly' as const, payRateCheck: 20.00, payRateOthers: 10.00, ptoBalance: 16.0, standardCheckHours: 40 },
  { id: 'emp006', firstName: 'Frank', lastName: 'Miller', email: 'frank.miller@example.com', mobileNumber: '6789012345', ssn: '***-**-8901', payMethod: 'Hourly' as const, payRateCheck: 35.00, payRateOthers: 20.00, ptoBalance: 120.0, standardCheckHours: 40 },
  { id: 'emp007', firstName: 'Grace', lastName: 'Lee', email: 'grace.lee@example.com', mobileNumber: '7890123456', ssn: '***-**-2345', payMethod: 'Hourly' as const, payRateCheck: 26.00, payRateOthers: 0.00, ptoBalance: 32.5, standardCheckHours: 40 },
  { id: 'emp008', firstName: 'Henry', lastName: 'Wilson', email: 'henry.wilson@example.com', mobileNumber: '8901234567', ssn: '***-**-6789', payMethod: 'Hourly' as const, payRateCheck: 18.50, payRateOthers: 10.00, ptoBalance: 0.0, standardCheckHours: 30 },
  { id: 'emp009', firstName: 'Ivy', lastName: 'Garcia', email: 'ivy.garcia@example.com', mobileNumber: '9012345678', ssn: '***-**-1122', payMethod: 'Hourly' as const, payRateCheck: 23.25, payRateOthers: 15.00, ptoBalance: 55.0, standardCheckHours: 40 },
  { id: 'emp010', firstName: 'Jack', lastName: 'Taylor', email: 'jack.taylor@example.com', mobileNumber: '0123456789', ssn: '***-**-3344', payMethod: 'Hourly' as const, payRateCheck: 40.00, payRateOthers: 25.00, ptoBalance: 10.0, standardCheckHours: 40 },
];
